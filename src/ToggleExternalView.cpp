...
XPLMDataRef DR_internalRoll, DR_internalHeading, DR_internalPitch;

XPLMDataRef DR_internalX, DR_internalY, DR_internalZ;
   ...
   if (inPhase == xplm_CommandEnd)
   {
      if (XPLMGetDatai(DR_isExternal))
      {
         ...
         if (internalPositionSaved)
            XPLMControlCamera(xplm_ControlCameraUntilViewChanges, setPosition,
                              nullptr);
